    ...
    Private Sub LoadVideo(youtubeUrl As String)
        ...
        If Not String.IsNullOrEmpty(videoId) Then
            Dim htmlContent As String = $"
                <html>
                    <body style='margin:0;'>
                        <iframe width='300' height='180' src='https://www.youtube-nocookie.com/embed/{videoId}' title='YouTube video player' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share' referrerpolicy='strict-origin-when-cross-origin' allowfullscreen></iframe>
                    </body>
                </html>"
