...
Partial Class LoginForm
    ...
    Private Sub InitializeComponent()
        ...
        btnGoToSignup = New Guna.UI2.WinForms.Guna2Button()
        Label3 = New Label()
        ...
        txtPassword.Location = New Point(320, 261)
        ...
        Label1.Location = New Point(320, 162)
        Label1.Name = "Label1"
        ...
        Label2.Location = New Point(320, 243)
        Label2.Name = "Label2"
        ...
        ' btnGoToSignup
        ' 
        btnGoToSignup.AllowDrop = True
        btnGoToSignup.BackColor = Color.Transparent
        btnGoToSignup.BorderColor = Color.WhiteSmoke
        ...
        btnGoToSignup.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnGoToSignup.Font = New Font("Arial Narrow", 11.25F, FontStyle.Bold)
        ...
        Label4.Font = New Font("Comic Sans MS", 18F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label4.ForeColor = Color.FromArgb(CByte(64), CByte(64), CByte(64))
        Label4.Location = New Point(355, 98)
        Label4.Name = "Label4"
        ...
        LinkLabel1.Font = New Font("Arial", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        LinkLabel1.Location = New Point(382, 324)
        LinkLabel1.Name = "LinkLabel1"
        LinkLabel1.Size = New Size(110, 16)
        ...
        MaximumSize = New Size(577, 450)
        MinimumSize = New Size(577, 450)
        Name = "LoginForm"
    ...
    Friend WithEvents btnGoToSignup As Guna.UI2.WinForms.Guna2Button
